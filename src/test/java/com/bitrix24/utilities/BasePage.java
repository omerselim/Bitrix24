...
public abstract class BasePage {
    ...
    public void navigateToModule(String tab, String module) {
        ...
        try {
            BrowserUtils.waitForPresenceOfElement(By.xpath(moduleLocator), Integer.parseInt(ConfigurationReader.getProperty("SHORT_WAIT")));
            BrowserUtils.waitForVisibility(By.xpath(moduleLocator), Integer.parseInt(ConfigurationReader.getProperty("SHORT_WAIT")));
            ...
            BrowserUtils.clickWithTimeOut(Driver.getDriver().findElement(By.xpath(moduleLocator)),  Integer.parseInt(ConfigurationReader.getProperty("SHORT_WAIT")));
        }
    }
